...
namespace DeathWeb.Controllers
{
    public class TransactionCategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name")] TransactionCategory transactionCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name")] TransactionCategory transactionCategory)
        {
            if (ModelState.IsValid)
            {
